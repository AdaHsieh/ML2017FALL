...
def main():
	...
	word_2vec=getmodel_word_2vec_embedding(text,True)
	...
	train_idx = get_train_index(word_2idx,label_x)
	...
	#model_path="./model1/weights-12-0.8209.hdf5"
	#model = load_model(model_path)
